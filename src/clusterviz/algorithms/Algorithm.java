...
public abstract class Algorithm {
    ...
    protected HashMap curNodeInfos = null;    //vector<Node> key is the node index, value is a NodeInfo instance    
    protected TreeMap curNodeScores = null; //key is node score, value is nodeIndex
    ...
    protected HashMap nodeInfoResultsMap = new HashMap(); //key is result, value is nodeInfroHashMap
    protected HashMap nodeScoreResultsMap = new HashMap();//key is result, value is nodeScoreSortedMap
    ...
    protected ArrayList getNeighbors(int nodeIndex){
    ...
    protected int[] getNeighborArray(CyNetwork network, int nodeIndex){
    	ArrayList ret=new ArrayList();
	...
	protected int searchInComplexes(ArrayList alClusters, Integer node){
    	int counter=0;
